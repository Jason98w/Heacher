...
{
    public partial class regist_class_use_info : Form
    {
        public regist_class_use_info(long cid)
        {
            InitializeComponent();
            ...
            sdr.Close();
            string sq2 = $@"SELECT [USERS].[SNO] ,[SEMAIL] ,[STEL] FROM [HEACHER].[dbo].[USERS] join USERS_ESTABLISH_COURSES on USERS.SNO=USERS_ESTABLISH_COURSES.SNO where USERS_ESTABLISH_COURSES.CID='{cid}'";
